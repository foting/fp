...
{
    public IOUAll(String url, String userName, String password) throws FPDBException, JSONException, MalformedURLException, IOException {
    ...
    class Reply extends FPDB.Reply
    {
        ...
        public String toString() {
        	return first_name +" " + last_name + " (anv.namn: "+ username +") har " + assets + " kr på banken.";
        }
    }
